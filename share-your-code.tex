...
Next choose the option to ``Create a new repository'' (Figure \ref{fig:Fig3}B, see https://help.github.com/articles/create-a-repo/).
...
You can do this by adding them as Collaborators on your repository (Settings -\textgreater Collaborators -\textgreater Add collaborator, see https://help.github.com/articles/adding-collaborators-to-a-personal-repository/).
