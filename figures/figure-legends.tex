...
\textbf{\label{fig:Fig1}. The git add/commit process.}
...
\textbf{\label{fig:Fig2}}. Working with both a local and remote repository as a single user.}
...
\textbf{\label{fig:Fig3}. Contributing to Open Source Projects.}
...
\textbf{\label{fig:S1_Fig}. Collaboration using GitHub.}
