...
\begin{enumerate}
  ...
  \begin{itemize}
    \item What is the problem? Filesystem full of analysis_01, analysis_02, analysis_03_final, etc.
    \item What is the solution? Explain basic idea of version control software
    \item Why is it so powerful? Increased reproducibility and collaboration, not only for code but also manuscripts
\end{itemize}
