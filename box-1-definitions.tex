...
\item \textbf{stage}: \textit{(noun)} the staging area holds the files to be committed in the next commit; \textit{(verb)} to mark a file to be committed in the next commit
